...
export function PokemonBottomSheet({ pokemon, onClose }: Props) {
  return (
    <div className="lg:hidden fixed inset-0 z-40 flex items-end">
      ...
      <div className="relative w-full rounded-t-2xl bg-white/60 backdrop-blur-[20px] border border-white/60 shadow-xl animate-slide-up max-h-[85vh] flex flex-col">

        {/* Header — transparent, shares outer glass surface */}
        <div className="flex-shrink-0 flex items-center justify-between rounded-t-2xl px-5 py-3 border-b border-white/30">
